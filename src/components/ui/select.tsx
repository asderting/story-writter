...
const Select = React.forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <select
        className={cn(
          'flex h-9 w-full items-center rounded-md border border-zinc-700 bg-zinc-900 px-3 py-1 text-sm text-zinc-50 shadow-sm',
          'focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-400',
          'disabled:cursor-not-allowed disabled:opacity-50',
          '[&>option]:bg-zinc-900 [&>option]:text-zinc-50',
